                        ...
                        {carasodDatas.map((item) => (
                            <SwiperSlide key={item.id} className="overflow-hidden">
                                <div className="relative flex justify-between">
                                    <div className="z-30">
                                        <h2 className={` text-[120px] font-bold uppercase -mr-5 mt-16 -mb-16`}>
                                            {item.title}
                                        </h2>
                                        <h2 className="text-[120px] font-bold uppercase -mr-52 text-right">
                                            {item.title2}
                                        </h2>
                                        <h2 className="text-[120px] font-bold uppercase -mr-5 -mt-16">
                                            {item.title3}
                                        </h2>
                                    </div>
                                    <img
