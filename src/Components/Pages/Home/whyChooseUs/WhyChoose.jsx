...
//     return (
//         <div key={key}
//             className="group relative h-[95vh] overflow-hidden flex ps-10"
//             style={{ margin: 0 }}
//         >

//             <div key={product.id} className="product-card  flex justify-center items-center" style={{ backgroundColor: `#${product?.color}` }}>
//                 <div className="w-[75em] flex justify-center items-center flex-col">
